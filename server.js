...
fastify.post("/", async function (request, reply) {
  range = new Date(request.body.start).toLocaleString('default', { month: 'long' });

  var start = new Date(request.body.start).toLocaleDateString();
  var end   = new Date(request.body.end  ).toLocaleDateString();
